...
![Pasted image 20260126163537.png](/img/user/z_attachments/Pasted%20image%2020260126163537.png)
...
When you cast a spell, the put in **Effort** to sculpt its effects. You always have to put in 1 Effort to channel magic. Greater effects require more Effort, but you can never put more than 3 Effort into a single casting. Putting in Effort requires freedom of body and mind: for every Effort you put into your spell, you need to have **one empty Inventory Slot**. If you don't have any free Inventory Slots, you can't wield magic. After you cast the spell, roll a d6 for each Effort you put in. For each die that comes up as a 1-3 you take one instance of **Strain**. 

If you try to channel a Runeskelf when you're **Deprived** or in a particularly tense or dangerous situation, there's a chance of the magic backfiring on you. The GM can require you to make a CLA or SPI Save, and on a failed save there will be an unforeseen and unfortunate side-effect to your magic in addition to the intended effect.
