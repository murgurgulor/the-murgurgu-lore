...
- Clarity encompasses your agility, quick-thinking, and keen instincts. If you are met with disorienting attacks or confusing situations, it lowers your Clarity.
...
Armor from Shields only functions if the Shield is worn in a hand.
Armor from helmets or chain mail only functions if it is worn on the body.
...
### Taking Action
Whenever you want to take an action, you - and the GM - should keep in mind the following steps:
1. **Intent** - What is it you are trying to achieve?
2. **Leverage** - What do you have, or what can you do that makes this possibe?
3. **Cost** - Is there a cost to your action, either in resource, damage, or side-effects?
...
- The factor of Gear checks whether you have the items - if any - required to perform your task. Climbing a wall might require a rope, but a sufficiently rough and cracked wall with enough handholds might also check the box.
...
- **Exposed**: You are Exposed if you are encumbered (carrying more items than you have slots for) or otherwise unable to defend yourself. When you are Exposed, you can't apply your Guard to damage.
- **Fatigued**: You can't perform any Feats.
...
- **Deprived**: You're Deprived if you haven't had sufficient food, drink, or rest for 24 hours. When you're Deprived, you can't recover your Guard in a short rest. If you are Deprived for more than 24 hours, you take one instance of Strain for every day you're Deprived thereafter.
...
Using your movement in your turn can shift your relative distance up or down one category (so from Nearby to Engaged for example, or from Nearby to Far Away). Using your action for extra movement allows you to shift two categories.

### Initiative
Combat rounds are around 10 seconds long, and every character on the same side takes their actions simultaneously. 
...
- Use an At Hand or Body item (switching At Hand/Body items can be part of this action)
- Switching an At Hand/Body item with a Pack item
...
### Gambits
Gambits are maneuvers you can make to apply an effect on your target. After you've rolled your attack dice, you can expend any die of 4 or higher to perform a Gambit. The affected target of the Gambit must be the target of the attack. Targets get to make a VIG Save to avoid the effect of a Gambit - with the exception of the Bolster and Move Gambit. If multiple characters make a Gambit against the same opponent at the same time, they can't perform the same Gambit. Gambits can never do something that would outright end combat, they only give a temporary advantage.

If the die expended to perform a Gambit is an 8 or higher, the target doesn't get to make a Save, or the Gambit has a greater and/or longer lasting effect. 
...
- **Impair**: Weaken the attacking power of an opponent on their next turn.
...
### Feats
Every character can perform the following 3 Feats in combat. You can only apply one Feat per character per attack. After you perform a Feat, roll the appropriate Save. On a failed Save you can't perform anymore Feats during this combat.

- **Frenzy**: You declare to Frenzy *when you declare your attack, before the dice have been rolled*. When you Frenzy, you choose to either deal *+d12* bonus damage, your attack gains the *Blast* property, or you leave a specific mark on your enemy. After you've rolled your attack dice, you roll a VIG Save.
- **Focus**: You declare to Focus *after you've rolled your attack dice*. When you Focus, you can perform a Gambit against your opponent without expending a die. After you've performed your Gambit, you roll a CLA Save.
...
- If you take damage to your Vigour, make a VIG Save using your new score. 
...
### Scars
When an attack in combat reduces your GD to exactly 0, you take a Scar. Consult the table below with How much GD you lost to determine the effect.
...
| 2 GD    | **Rattling Blow**: You’re disoriented and shaken. Describe how you refocus.<br>Roll 1d6. If the total is higher than your max GD, take the new result.                                                                                 |
| 3 GD    | **Walloped**: You’re sent flying and land flat on your face, winded. You are<br>**Deprived** until you rest for a few hours. Then, roll 1d6. Add that amount to<br>your max GD.                                                        |
...
| 12 GD   | **Doomed**: Death seemed ever so close, but somehow you survived. When you next take a Wound, roll a VIG Save. If it is a fail, you die horribly. If you pass, roll 3d6. If the total is higher than your max GD, take the new result. |

### Recovering
To recover your GD, you need to rest for around 10 minutes and consume a Ration. Afterwards, your GD is fully recovered.

Attribute Damage is recovered at one point per day's rest. If multiple attributes are damaged, choose which one to recover a point in.
...
**Reach Weapons** (d10, Bulky): Weapons that require both hands to use. May be Impaired in confined spaces.
- Greatsword, Glaive, Halberd
**Ranged Weapons**:
- Sling (d4), Javelin (d6), Bow (d6, Bulky), Crossbow (d8, Bulky, must be reloaded after an attack)
...
Cairn:
- Modified Event Die (4-6 is quiet, increase pool for danger)
