---
{"dg-publish":true,"permalink":"/cairn/witchcairn-a-cairn-hack/"}
---
...
2. When moving forward, players are presented with relevant and pertinent Information
...
- You have **Skill** if your character would be the kind of person who would be able to do the thing that you want to do.
...
When you perform a Gambit, the target of the Gambit must be the target of the attack. 
...
Ranged Weapons can target anyone you can see, but attacks against *Distant* targets are *Impaired*.
...
- **Plate Mail**: +3 Armor, *Bulky*, must be worn in both *Body* slots. Difficult to move around in.
...
| Category            | Item                                               | Price (Silver Guilders) |
| ------------------- | -------------------------------------------------- | ----------------------- |
