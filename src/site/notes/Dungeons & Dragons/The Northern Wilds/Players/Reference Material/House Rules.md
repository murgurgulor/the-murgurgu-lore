...
- At the start of the session, one of the players is assigned as the **Scribe**. It's the Scribe's responsibility to keep track of the Initiative Order in combat, call out who's turn is up and whose turn will come after.
...
- The DM determines the opponents' Initiative by taking their **Passive Initiative**, and applying a +5 modifier for Boss monsters and a -5 modifier for Minion monsters. The DM groups opponents together with ideally no more than 2 Initiative counts for the opponents.
- At the start of combat, the DM declares the opponents' Initiative Counts to the Scribe
- Then, each player rolls **Initiative** as normal. The Scribe then groups characters together based on whether they're **Before the Opponents**, **In Between Opponents** or **After Opponents**
+ The Scribe notes down the Initiative Order per groups of characters and opponents.
